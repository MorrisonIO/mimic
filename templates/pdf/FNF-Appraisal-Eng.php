            ...
            <div class="template-content">
                ...
                <div class="text-block">
                        ...
                        {% if not context %}
                            ...
                            <p class="absolute size-2 font-1 left-align color-3 placeholder txt-15 fax" data-placeholder="Toll-Free Phone"><span class="kind color-1">tf</span>Toll Free</p>
                            <p class="absolute size-2 font-1 left-align color-3 placeholder txt-15 cell" data-placeholder="Cell Phone"><span class="kind color-1">c </span>Cell Phone</p>
                            ...
                            <p class="absolute size-2 font-2 left-align color-1 placeholder txt-15 web">Text 8 (Web)</p>
                        ...
                        {% else %}
                            ...
                            <p class="absolute size-2 font-1 left-align color-3 placeholder txt-15 cell" data-placeholder="Cell Phone"><span class="kind color-1">c </span> {{context.cell_phone}} </p>
                ...
                <div class="logo-2">
                    <img class="temp-img" alt="logo" src="/media/brochure_staff/logos/fnf-appraisal.svg" style="width: 122px;height: 31px;display: block;">
