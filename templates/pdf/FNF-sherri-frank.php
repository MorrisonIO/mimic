...
/*            src: url('./Sherri-Frank-FNF-assests/fonts/nexa_bold-webfont.woff2') format('woff2'),
                 url('./Sherri-Frank-FNF-assests/fonts/nexa_bold-webfont.woff') format('woff');*/
            src: url('/media/brochure_staff/Sherri-Frank-FNF-assests/fonts/nexa_bold-webfont.woff2') format('woff2'),
                 url('/media/brochure_staff/Sherri-Frank-FNF-assests/fonts/nexa_bold-webfont.woff') format('woff');
...
/*            src: url('./Sherri-Frank-FNF-assests/fonts/nexa_light-webfont.woff2') format('woff2'),
                 url('./Sherri-Frank-FNF-assests/fonts/nexa_light-webfont.woff') format('woff');*/
            src: url('/media/brochure_staff/Sherri-Frank-FNF-assests/fonts/nexa_light-webfont.woff2') format('woff2'),
                 url('/media/brochure_staff/Sherri-Frank-FNF-assests/fonts/nexa_light-webfont.woff') format('woff');
            font-weight: normal;
            font-style: normal;
...
/*            src: url('./Sherri-Frank-FNF-assests/fonts/nexaregular-webfont.woff2') format('woff2'),
                 url('./Sherri-Frank-FNF-assests/fonts/nexaregular-webfont.woff') format('woff');*/
            src: url('/media/brochure_staff/Sherri-Frank-FNF-assests/fonts/nexaregular-webfont.woff2') format('woff2'),
                 url('/media/brochure_staff/Sherri-Frank-FNF-assests/fonts/nexaregular-webfont.woff') format('woff');
            font-weight: normal;
            font-style: normal;
...
/*            -moz-transform: scale(1, -1);
        ...
        .sherri-bg {
            /*background-image: url('./Sherri-Frank-FNF-assests/images/Sherri-Frank-FNF--bg.jpg');*/
            background-image: url('/media/brochure_staff/Sherri-Frank-FNF-assests/images/bg.png');
...
<body>
    <div class="template-pages">
        <div class="template-page sherri-bg">

            <div class="template-content">
<!-- 
                <div class="logo-1 left-align">
                    <img class="temp-img" alt="logo" src="/media/brochure_staff/Sherri-Frank-FNF-assests/images/logo.png">
                    <img class="temp-img" alt="logo" src="./Sherri-Frank-FNF-assests/images/logo.png">
                </div>
-->
                <div class="text-block">
                        ...
                        {% if not context %}
                            ...
                            <p class="absolute size-1 font-2 left-align color-1 placeholder name" data-placeholder="Full Name">Sherri Frank</p>
                            ...
                            <p class="absolute size-2 font-1 left-align color-3 placeholder txt-15 email" data-placeholder="E-mail"><span class="kind color-1">e </span>Email</p>
