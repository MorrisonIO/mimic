            ...
            <div class="template-content">
                ...
                <div class="text-block">
                        ...
                        {% if not context %}
                            ...
                            <p class="absolute size-2 font-1 left-align color-3 placeholder txt-15 email" data-placeholder="Email"><span class="kind color-1">e </span>Email</p>
                        ...
                        {% else %}
                            ...
                            <p class="absolute size-2 font-1 left-align color-3 placeholder txt-15 email" data-placeholder="Email"><span class="kind color-1">e </span> {{context.email}}</p>
