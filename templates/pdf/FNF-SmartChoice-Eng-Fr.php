...
<!--                         <p class="usertext1 placeholder" data-placeholder="Department">{{context.department}}</p> -->
                        {% if not context %}
...
<!--                         <p class="usertext1 placeholder" data-placeholder="Department-French">{{context.departmentfrench}}</p> -->
                        {% if not context %}
                            ...
                            <p class="absolute size-2 font-1 left-align color-3 placeholder txt-15 office" data-placeholder="Office Phone-French"><span class="kind color-1" data-placeholder="Office Phone-French">o</span>Office Phone-French</p>
                ...
                <div class=" logo-2">
                    <img class="temp-img" alt="logo" src="/media/brochure_staff/logos/smartchoice-fr.svg" style="width: 122px;height: 31px;display: block;">
                    <!-- <img class="temp-img" alt="logo" src="./logos/smartchoice.svg"> -->
                </div>
            </div>
        </div>
