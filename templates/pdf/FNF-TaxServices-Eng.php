            ...
            <div class="template-content">
                ...
                <div class="text-block">
                        ...
                        {% if not context %}
                            ...
                            <p class="absolute size-2 font-2 left-align color-1 placeholder txt-15 web" data-placeholder="Web">Web</p>
                        ...
                        {% else %}
                            ...
                            <p class="absolute size-2 font-2 left-align color-1 placeholder txt-15 web" data-placeholder="Web">{{context.web_address}}</p>
