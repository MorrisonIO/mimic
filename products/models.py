...
class Category(models.Model):
    ...
    sort = models.IntegerField(blank=True, null=True, help_text="Enter an integer to create an order that categories will be displayed in. Note that other categories will need a value as well.")
...
class Product(models.Model):
    ...
    min_order_qty = models.PositiveIntegerField("Minimum order quantity", blank=True, null=True, help_text="Ensure this does not conflict with any fixed quantities below.")
    ...
    replenish_threshold = models.PositiveIntegerField(blank=True, null=True, help_text="Send an email alert when inventory drops below this amount.")
    ...
    sort = models.IntegerField(blank=True, null=True, help_text="Enter an integer to create an order that products will be displayed in. Note that other products will need a value as well.")
