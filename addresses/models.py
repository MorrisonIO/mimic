...
class Address(models.Model):
    """
    A contact or frequently shipped-to location. Addresses may be saved as belonging to a particular user, in which case they appear in the user's Address Book.
    """
