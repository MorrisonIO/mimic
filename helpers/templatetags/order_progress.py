...
@register.inclusion_tag('templatetags/creation_progress_brochures.html')
def show_creation_progress_brochures(request, page):
    """
...
@register.inclusion_tag('templatetags/creation_progress_cards.html')
def show_creation_progress_cards(request, page):
    """
    Makes the creation pdf progress graphic so the user can gauge progress
    and return to previous ordering pages.
    `page` is a string representing the current page in the ordering process,
